  ...
  function routeConfig($stateProvider) {
    $stateProvider
      ...
      .state('categories.list', {
        url: '',
        templateUrl: 'modules/tradies/client/views/list-categories.client.view.html',
      ...
      .state('categories.create', {
        url: '/create',
        templateUrl: 'modules/tradies/client/views/form-category.client.view.html',
      ...
      .state('categories.view', {
        url: '/:categoryId',
        templateUrl: 'modules/tradies/client/views/view-category.client.view.html',
        controller: 'CategoriesController',
        controllerAs: 'vm',
        resolve: {
          categoryResolve: getCategory
